...
void make_obb(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud,
              ...
              std::string name)
{
  ...
  viewer->addCube (position, quat, max_point_OBB.x - min_point_OBB.x, max_point_OBB.y - min_point_OBB.y, max_point_OBB.z - min_point_OBB.z, "OBB"+name);
  viewer->setShapeRenderingProperties(pcl::visualization::PCL_VISUALIZER_COLOR,0,0,1,"OBB"+name);
  viewer->setShapeRenderingProperties(pcl::visualization::PCL_VISUALIZER_OPACITY,0.1,"OBB"+name);
  viewer->setShapeRenderingProperties(pcl::visualization::PCL_VISUALIZER_LINE_WIDTH,8,"OBB"+name);
 ...
 */
  ...
  //viewer->addArrow(x_axis, center, 1.0, 0.0, 0.0, false, "arrow_x"+name);
  //viewer->addArrow(y_axis, center, 0.0, 1.0, 0.0, false, "arrow_y"+name);
  //viewer->addArrow(z_axis, center, 0.0, 0.0, 1.0, false, "arrow_z"+name);
...
int main (int argc, char** argv)
{
  ...
  if (argc != 2)
    return (0);
    */
  std::string file_name1 = "/home/bianjingyang/catkin_realsense/src/io_files/cloud_cluster_0.pcd";
  std::string file_name2 = "/home/bianjingyang/catkin_realsense/src/io_files/cloud_cluster_1.pcd";
  pcl::PointCloud<pcl::PointXYZ>::Ptr cloud1 (new pcl::PointCloud<pcl::PointXYZ> ());
  if (pcl::io::loadPCDFile (file_name1, *cloud1) == -1)
    return (-1);

  pcl::PointCloud<pcl::PointXYZ>::Ptr cloud2 (new pcl::PointCloud<pcl::PointXYZ> ());
  if (pcl::io::loadPCDFile (file_name2, *cloud2) == -1)
    return (-1);
  ...
  viewer->addPointCloud<pcl::PointXYZ> (cloud1,pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ>(cloud1,255,0,0), "sample cloud");
  viewer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE,5,"sample cloud");
  viewer->addPointCloud<pcl::PointXYZ> (cloud2,pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ>(cloud2,0,255,0), "sample cloud2");
  viewer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE,5,"sample cloud2");

  make_obb(cloud1,viewer,"name1");
  make_obb(cloud2,viewer,"name2");
